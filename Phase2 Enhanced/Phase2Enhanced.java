...
public class Phase2Enhanced{
	...
	static boolean F;	//A flag 
	static char R1[] = new char [4];
	...
	public static void main(String[] args) {
		...
		Phase2Enhanced phase2 = new Phase2Enhanced();
		phase2.Load();
	...
	private static void writeTwoBlankLines() {
		// TODO Auto-generated method stub
		 ...
		 File file = new File("C:\\Users\\naikw\\workspace\\MultiprogrammingOS\\src\\myOS\\output15.txt");
	     FileWriter fr = null;
	...
	void Load(){
		...
		System.out.println("inload");
			File file = new File("C:\\Users\\naikw\\workspace\\MultiprogrammingOS\\src\\myOS\\input8.txt");
			...
			if(PI!=0){
				...
				switch(IR[0]+IR[1]){
					...
					case 'A'+'D':
					{
						...
						int operandFirst = Integer.parseInt(operandOne);
						...
						int operandSecond = Integer.parseInt(operandTwo);
						...
						for(int i=0;i<resultString.length();i++){
							if(i<4)
								R1[i] = resultString.charAt(i);
							else
								R2[i-j] = resultString.charAt(i);
					...
					case 'D'+'V':
					{
						...
						int result = operandFirst/operandSecond;
						int remainder = operandFirst%operandSecond;
					...
					case 'A'+'N':
					{
						...
						int operandFirst = Integer.parseInt(operandOne);
						String binaryOperandOne = Integer.toBinaryString(operandFirst);
						...
						String binaryOperandTwo = Integer.toBinaryString(operandSecond);
						
						
						String appendZero = new String();
						if(binaryOperandOne.length() < 4){
							if(binaryOperandOne.length() == 1)
								appendZero = "000";
							else if(binaryOperandOne.length() == 2)
								appendZero = "00";
							else if(binaryOperandOne.length() == 3)
								appendZero = "0";
							
							binaryOperandOne = appendZero + binaryOperandOne;
						}
						
						if(binaryOperandTwo.length() < 4){
							if(binaryOperandTwo.length() == 1)
								appendZero = "000";
							else if(binaryOperandTwo.length() == 2)
								appendZero = "00";
							else if(binaryOperandTwo.length() == 3)
								appendZero = "0";
							
							binaryOperandTwo = appendZero + binaryOperandTwo;
						}
						
						
						System.out.println("Binary operand one: "+binaryOperandOne);
						System.out.println("Binary operand two: "+binaryOperandTwo);
						
						String result = new String();
						
						for(int i=0;i<4;i++){
							if(Integer.parseInt(""+binaryOperandOne.charAt(i))==1 && Integer.parseInt(""+binaryOperandTwo.charAt(i))==1){
								result += "1";
							}
							else 
								result += "0";
					...
					case 'O'+'R':
					{
						...
						for(int i=0;i<4;i++){
							if(Integer.parseInt(""+binaryOperandOne.charAt(i))==0 && Integer.parseInt(""+binaryOperandTwo.charAt(i))==0){
								result += "0";
							}
							else 
								result += "1";
					...
					case 'N'+'T':
					{
						...
						for(int i=0;i<4;i++){
							if(Integer.parseInt(""+binaryOperandOne.charAt(i))==0){
								result += "1";
							}
							else 
								result += "0";
					...
					case 'X'+'R':
					{
						...
						for(int i=0;i<4;i++){
							if(Integer.parseInt(""+binaryOperandOne.charAt(i))==0 && Integer.parseInt(""+binaryOperandTwo.charAt(i))==0 ||
								Integer.parseInt(""+binaryOperandOne.charAt(i))==1 && Integer.parseInt(""+binaryOperandTwo.charAt(i))==1){
								result += "0";
							}
							else 
								result += "1";
